...
@section('links')
    ...
    <script type="text/javascript">
        ...
        const generateProgressBars = family =>
        {
            ...
            {
                if (element.clinical_history != null && element.clinical_history.progress < 100)
                {
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 py-2">
                                                        ...
                                                        <div class="col-md-12">
                                                            <select class="form-control selectpicker my-2" multiple
                                                                id="txtCancer"
                                                                title="{{ ucwords(GoogleTranslate::justTranslate('Cancer Relatives', app()->getLocale())) }}"
                                                                disabled>
                                                                <option value="1">
                                                                    {{ ucwords(GoogleTranslate::justTranslate('Mother', app()->getLocale())) }}
                                                                </option>
                                                            ...
                                                            <div class="d-block">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        ...
                                                                        onchange="disableField(this.id);">
                                                                    <label class="form-check-label"
                                                                        for="switchPsychiatric">{{ ucwords(GoogleTranslate::justTranslate('Psiquiátricas', app()->getLocale())) }}</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                        ...
                                        <form class="validationNonPathAnt" id="formNonPathAnt" novalidate>
                                            <div class="form-card">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <h6 class="fw-bolder py-2 pt-3">
                                                        {{ ucwords(GoogleTranslate::justTranslate('Tabaquismo', app()->getLocale())) }}
                                                    </h6>
                                                    <div class="row d-block">
                                                        <div class="d-block">
                                                            <div class="form-check form-check-inline">
                                                    ...
                                                    <h6 class="fw-bolder py-2 pt-3">
                                                        {{ ucwords(GoogleTranslate::justTranslate('Drug addiction', app()->getLocale())) }}
                                                    </h6>
                                                    <div class="row d-block">
                                                        <div class="d-block">
                                                            <div class="form-check form-check-inline">
                                        ...
                                        <form class="validationPersonalPathHis" id="formPersonalPathHis" novalidate>
                                            <div class="form-card">
                                                <div class="row">
                                                    ...
                                                    <h6 class="fw-bolder py-2 pt-3">
                                                        {{ ucwords(GoogleTranslate::justTranslate('Alergias', app()->getLocale())) }}
                                                    </h6>
                                                    <div class="row d-block">
                                                        <div class="d-block">
                                                            <div class="form-check form-check-inline">
